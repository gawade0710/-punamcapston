...
<a href="#" data-toggle="modal" data-target="#login" >Examiner </a></div>
<div class="col-md-3 box" id="bt2">
<a href="  http://localhost/StudentResult/StudentResult/" data-toggle="modal"  >Administrator </a></div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers" style="margin-left:-100px;">Contact Us</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <<div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9112814223</h4>
	  ...
	  <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9975273442</h4>
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7350847439</h4>
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7038091313</h4>
		<h4 style="font-family:'typo' ">sakshisuryawa@gmail.com</h4>
		<h4 style="font-family:'typo' ">Government Ploytechnic Awasari(kh)</h4></div></div>
		</p>
      </div>
