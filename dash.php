...
@keyframes slider{
	...
	55%{
	background-image:url("clg7.jpg");}
	65%{
	background-image:url("hmi.jpg");}
	105%{
	background-image:url("clg8.jpg");}
...
h1{
	...
	font-size:45px;
	margin-top:50px;
	  background-image: linear-gradient(blue,indigo,violet);
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
   ...
   <ul class="navi">
        ...
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0" id="hm1" style="color:white;">Home<span class="sr-only">(current)</span></a></li>
        ...
        </li><li class="pull-right" > <a href="logout.php?q=account.php" style="color:white;"><span class="glyphicon glyphicon-log-out" aria-hidden="true"  style="color:white;"></span>&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
...
if(@$_GET['q']== 0) {
	...
	echo'<h1 class="animate__animated animate__heartBeat" style="margin-left:100px;"><b>WELCOME TO ONLINE EXAMINATION-2021</b></h1>';
	echo'<p style="margin-top:450px;">Online Examination System is a technology-driven way to simplify examination activities like defining exam patterns with question banks, defining exam timer, objective/ subjective question sections, conducting exams using the computer or mobile devices in a paperless manner.
...
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Enrollment.NO</b></td><td><b>Branch</b></td><td><b>College</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$enroll.'</td><td>'.$branch.'</td><td>'.$college.'</td><td>'.$email.'</td><td>'.$mob.'</td><td>'.$pass.'</td>
